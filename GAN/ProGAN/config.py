...
data_dir = '/content/drive/MyDrive/Colab Notebooks/Thorax_GAN-master'
result_dir = '/content/drive/MyDrive/Colab Notebooks/Thorax_GAN-master/CheXpert_256/GAN_CheXpert'
...
#desc += '-NIH_256';              dataset = EasyDict(tfrecord_dir='TF_data_NIH_256_100%')
...
desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 17000
...
#desc += '-fp16'; G.dtype = 'float16'; D.dtype = 'float16'; G.pixelnorm_epsilon=1e-4; G_opt.use_loss_scaling = True; D_opt.use_loss_scaling = True; sched.max_minibatch_per_gpu = {512: 16, 1024: 8}; train.save_weight_histograms = True
#desc += '-fp16'; G.dtype = 'float16'; D.dtype = 'float16'; G.pixelnorm_epsilon=1e-4; G_opt.use_loss_scaling = True; D_opt.use_loss_scaling = True; sched.max_minibatch_per_gpu = {512: 16, 1024: 8}
#desc += '-fp16'; G.dtype = 'float16'; D.dtype = 'float16'; sched.max_minibatch_per_gpu = {512: 12, 1024: 6}; train.save_weight_histograms = True
...
#train = EasyDict(func='util_scripts.evaluate_metrics', run_id=1, log='metric-is-10k.txt', metrics=['is'], num_images=10000, real_passes=1); num_gpus = 1; desc = train.log.split('.')[0] + '-' + str(train.run_id)
#train = EasyDict(func='util_scripts.evaluate_metrics', run_id=1, log='metric-msssim-5k-infiltrate.txt', metrics=['msssim'], num_images=5000, real_passes=1); num_gpus = 1; desc = train.log.split('.')[0] + '-' + str(train.run_id)
