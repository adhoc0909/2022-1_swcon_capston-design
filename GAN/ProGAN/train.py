...
def train_progressive_gan(
    ...
    resume_run_id = '/content/drive/MyDrive/Colab Notebooks/Thorax_GAN-master/CheXpert_256/GAN_CheXpert/012-pgan-CheXpert-preset-v2-1gpu-fp32-HIST/network-snapshot-016320.pkl'
    resume_kimg = 16320.0
    # resume_run_id = '/content/drive/MyDrive/Colab Notebooks/Thorax_GAN-master/network-final.pkl'
    # resume_kimg = 15000
    # Construct networks.
